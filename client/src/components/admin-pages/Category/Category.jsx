...
const Category = () => {
  ...
  const getAllData = (pageNo) => {
    ...
    const options = {
      method: "GET",
      url: `/api/category/getallCategory?page=${pageNo}&limit=${visiblePageCount}`,
      headers: {
        Authorization: token,
      ...
      <section className="">
        <div className=" mx-auto">
          <div className="rounded-[10px] bg-white py-[20px] flexBetween flex-col md:flex-row gap-3 px-[20px] mt-[20px] lg:mt-0">
            <p className=" text-[22px] font-semibold">Category list</p>
              ...
              <table className="w-full table-auto mt-[20px] ">
                ...
                <tbody>
                  {Array.isArray(allData?.categories) &&
                    ...
                    allData?.categories?.map((items, index) => (
                      <tr key={index}>
          ...
          {allData?.total_pages > 1 && (
            <Pagination
              ...
              totalCount={allData?.total_pages}
